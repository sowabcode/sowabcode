      ...
      <div className="grid place-items-center max-md:flex my-anima">
        <div className="h-[620px] w-1 bg-gray-300 rounded-full relative max-sm:h-[650px] my-anima">
          ...
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: true, amount: 0.3 }}
            className="bg-white w-[460px] absolute top-12 right-[1900%] rounded-lg px-4 py-2 my-anima max-xl:w-[420px] max-lg:right-[1500%] max-lg:w-[300px] max-md:left-[1900%] max-md:w-[450px] max-sm:w-[300px] max-[500px]:left-[1200%] max-[400px]:left-[1000%] max-[400px]:w-[270px] shadow-lg my-anima"
          >
